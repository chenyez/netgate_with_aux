...
class HAR_Dataset(data_utils.Dataset):
    def __init__(self, train, noise):
        ...
        if train == True:
            self.body_acc_x_train = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/body_acc_x_train.txt')
            self.body_acc_x_train = torch.from_numpy(self.body_acc_x_train).type(torch.FloatTensor)
            
            self.body_acc_y_train = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/body_acc_y_train.txt')
            self.body_acc_y_train = torch.from_numpy(self.body_acc_y_train).type(torch.FloatTensor)

            self.body_acc_z_train = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/body_acc_z_train.txt')
            self.body_acc_z_train = torch.from_numpy(self.body_acc_z_train).type(torch.FloatTensor)

            self.body_gyro_x_train = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/body_gyro_x_train.txt')
            self.body_gyro_x_train = torch.from_numpy(self.body_gyro_x_train).type(torch.FloatTensor)

            self.body_gyro_y_train = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/body_gyro_y_train.txt')
            self.body_gyro_y_train = torch.from_numpy(self.body_gyro_y_train).type(torch.FloatTensor)

            self.body_gyro_z_train = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/body_gyro_z_train.txt')
            self.body_gyro_z_train = torch.from_numpy(self.body_gyro_z_train).type(torch.FloatTensor)

            self.label = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/y_train.txt') - 1
            self.label = torch.from_numpy(self.label).type(torch.LongTensor)

        else:
            self.body_acc_x_test = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/body_acc_x_test.txt')
            self.body_acc_x_test = torch.from_numpy(self.body_acc_x_test).type(torch.FloatTensor)
            
            self.body_acc_y_test = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/body_acc_y_test.txt')
            self.body_acc_y_test = torch.from_numpy(self.body_acc_y_test).type(torch.FloatTensor)

            self.body_acc_z_test = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/body_acc_z_test.txt')
            self.body_acc_z_test = torch.from_numpy(self.body_acc_z_test).type(torch.FloatTensor)

            self.body_gyro_x_test = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/body_gyro_x_test.txt')
            self.body_gyro_x_test = torch.from_numpy(self.body_gyro_x_test).type(torch.FloatTensor)

            self.body_gyro_y_test = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/body_gyro_y_test.txt')
            self.body_gyro_y_test = torch.from_numpy(self.body_gyro_y_test).type(torch.FloatTensor)

            self.body_gyro_z_test = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/body_gyro_z_test.txt')
            self.body_gyro_z_test = torch.from_numpy(self.body_gyro_z_test).type(torch.FloatTensor)

            self.label = np.loadtxt('/home/chenye/myung_netgate/Data/chenye_pytorch_code/noise_acc_z_gyro_y/y_test.txt') - 1
            self.label = torch.from_numpy(self.label).type(torch.LongTensor)
